...
set -g window-status-format "#[bg=#d6d6d6]  #I  #W  "
set -g window-status-current-format "#[fg=#d6d6d6,bg=#afafaf]#[fg=#666666,bg=#afafaf,noreverse,nobold] #I  #W #[fg=#afafaf,bg=#d6d6d6,nobold]"
set -g status-right 'Next: #[fg=black]#(sed -ne "2p" /tmp/gcalcli_agenda.txt) #[fg=#afafaf,bg=#d9d9d9,nobold] #[fg=#666666,bg=#afafaf] #(~/.tmux/scripts/basic-cpu-and-memory.py) #[fg=#1564a7,bg=#afafaf,nobold]#[fg=white,bg=#1564a7] %a %b %d %I:%M %p'
