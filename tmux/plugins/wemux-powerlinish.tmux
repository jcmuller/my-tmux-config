...
set -g status-right '#[fg=#afafaf,bg=#d9d9d9,nobold]#[fg=#666666,bg=#afafaf] #(~/.tmux/scripts/basic-cpu-and-memory.py) #[fg=#1564a7,bg=#afafaf,nobold]#[fg=white,bg=#1564a7] %a %b %d %I:%M %p  Bat: #(~/.tmux/scripts/battery.sh)'
